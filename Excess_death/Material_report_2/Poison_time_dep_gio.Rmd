...
france_covid <- as.vector(as.matrix(france_belgium_norway)[-c(17,18),2])
```
...
data_list_france <- create_list(length(mean_france), as.vector(mean_france + france_covid), france_2020)
