...
Fig.\ref{fig:fig1} and Fig.\ref{fig:fig1bis} show the weekly deaths from weeks  
<!-- is it 1:17 or 2-17?? -->
...
```{r, echo = FALSE, eval = TRUE, fig.cap="\\label{fig:fig1bis} Weekly deaths by year and country"}
